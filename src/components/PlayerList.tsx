...
export default function PlayerList({
  ...
  return (
    <div className="bg-gradient-to-br from-gray-900 via-black to-gray-900 rounded-2xl p-6 border-2 border-poker-gold-600 border-opacity-40 shadow-xl shadow-poker-gold-500/20">
      <div className="flex items-center gap-3 mb-4">
        <div className="text-3xl">👥</div>
        <h2 className="text-2xl font-display font-bold text-poker-gold-400">玩家列表</h2>
      </div>
