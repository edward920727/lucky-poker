  ...
  return (
    <div className="bg-gradient-to-br from-gray-900 via-black to-gray-900 rounded-2xl p-6 mb-6 border-2 border-poker-gold-600 border-opacity-40 shadow-xl shadow-poker-gold-500/20">
      <div className="flex items-center gap-3 mb-4">
        ...
        <h2 className="text-2xl font-display font-bold text-poker-gold-400">財務統計</h2>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-6">
        ...
        <div className="relative bg-gradient-to-br from-purple-600 to-purple-800 p-4 rounded-xl shadow-xl border-2 border-purple-500 border-opacity-50 overflow-hidden group">
          <div className="absolute top-0 right-0 w-20 h-20 bg-white opacity-5 transform rotate-45 translate-x-10 -translate-y-10"></div>
          <div className="relative z-10">
            <p className="text-sm font-semibold text-purple-200 mb-1">🎯 點數</p>
            <p className="text-2xl font-black text-white">NT$ {pointsTotal.toLocaleString()}</p>
          </div>
        </div>
